  ...
  Future<void> _showPermissionDialog() async {
    return showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          scrollable: true, // Set to true to enable scrolling
          title: Text(
            'Permission Required',
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: context.currentTextTheme.bodySmall,
                  ),
                  ...
                  Text(
                    ' This app uses your device location (background and when in use) to facilitate users by showing them the current location of food trucks.',
                    style: context.currentTextTheme.bodySmall,
                  ),
                  const SizedBox(height: 10),
                  Text(
                    'Your location is only accessed for the purpose of providing correct locations to users of the app and is not shared with third parties.',
                    style: context.currentTextTheme.bodySmall,
                  ),
                  const SizedBox(height: 10),
                  const Text(
                  ...
                  Text(
                    ' To notify you about new food truck locations and promotions.',
                    style: context.currentTextTheme.bodySmall,
                  ),
                ],
              ),
