...
class CustomFirestoreListView<Document> extends FirestoreQueryBuilder<Document> {
    ...
    builder: (context, snapshot, _) {
      ...
      return ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return itemBuilder(context, doc, index == snapshot.docs.length - 1, snapshot.hasMore);
        },
...
typedef FirestoreItemBuilder<Document> = Widget Function(BuildContext context, QueryDocumentSnapshot<Document> doc, bool isLastIndex, bool hasMore);

typedef FirestoreLoadingBuilder = Widget Function(BuildContext context);

typedef FirestoreErrorBuilder = Widget Function(BuildContext context, Object error, StackTrace stackTrace);
