  ...
  static EdgeInsetsGeometry only(
    ...
    if (withResponsive) {
      return EdgeInsets.only(
          left: MySizer.getScaledSizeHeight(left),
          right: MySizer.getScaledSizeHeight(right),
          top: MySizer.getScaledSizeHeight(top),
          bottom: MySizer.getScaledSizeHeight(bottom));
    } else {
      return EdgeInsets.only(
