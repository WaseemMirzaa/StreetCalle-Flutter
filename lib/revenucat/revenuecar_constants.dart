...
const entitlementIDInd = 'Individual';
const entitlementIDNew = 'Pro';
const entitlementIDInter = 'Intermediate';
const entitlementIDEstab = 'Established';
...
const appleApiKey = 'appl_jnwNgRrmTqnyuKGsjHolmxtcYPl';

//TO DO: add the Google API key for your app from the RevenueCat dashboard: https://app.revenuecat.com
const googleApiKey = 'goog_eVoBcGsxTiwQWdNPCVpHeXsLCkz';
